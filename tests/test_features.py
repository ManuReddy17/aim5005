...
class TestFeatures(TestCase):
    ...
    def test_standard_scaler_transform(self):
        ...
        scaler.fit(data)
        result = scaler.transform(data)  # Corrected this line
    ...
    def test_standard_scaler_fit_transform(self):
        ...
        assert (result == expected).all(), "Scaler fit_transform does not return expected values. Expect {}. Got: {}".format(expected.reshape(1, -1), result.reshape(1, -1))
